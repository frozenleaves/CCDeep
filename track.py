...
if __name__ == '__main__':
    fp_json = r'G:\20x_dataset\copy_of_xy_16\copy_of_1_xy16.json'
    fp_pcna = r'G:\20x_dataset\copy_of_xy_16\raw\copy_of_1_xy16-mcy.tif'
    fp_bf = r'G:\20x_dataset\copy_of_xy_16\raw\copy_of_1_xy16-dic.tif'
    ...
    table.to_csv(r'G:\20x_dataset\copy_of_xy_16\tracked.csv', index=False)
    ...
    out = s.doResolve()
    out[0].to_csv(r'G:\20x_dataset\copy_of_xy_16\refined.csv', index=False)
    out[1].to_csv(r'G:\20x_dataset\copy_of_xy_16\phase.csv', index=False)
