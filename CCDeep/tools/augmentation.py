...
def get_src():
    mcy_src_G = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\mcy\G'
    mcy_src_M = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\mcy\M'
    mcy_src_S = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\mcy\S'
    dic_src_G = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\dic\G'
    dic_src_M = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\dic\M'
    dic_src_S = r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\dic\S'
    return [dic_src_G, mcy_src_G], [dic_src_M, mcy_src_M], [dic_src_S, mcy_src_S]


def run():
    src_dic, src_mcy = get_src()[1]
