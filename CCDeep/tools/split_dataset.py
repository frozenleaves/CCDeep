...
if __name__ == '__main__':
    ...
    split_dataset = SplitDataset(dataset_dir=r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\augment_mcy',
                                 saved_dataset_dir=r'G:\20x_dataset\copy_of_xy_01\train_data_dev1.3.2\train_mcy',
                                 show_progress=False)
